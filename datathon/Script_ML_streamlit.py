...
df = pd.read_csv("https://gitlab.com/isnardynicolas/wcs_import/-/raw/main/datathonbbq.csv")
...
df_google_sheet = pd.read_csv("https://gitlab.com/isnardynicolas/wcs_import/-/raw/main/tableau_csv_-_Feuille_1.csv")
